...
public class ExtravaganzaRenderLayers {
	...
	private static final Set<String> CUTOUT = Set.of("sapling", "table", "popcorn", "cotton_candy", "garland", "pinata", "hanging_lights", "grate", "traversable", "windowed", "ladder", "confetti");
